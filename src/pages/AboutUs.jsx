    ...
    return(
        ...
        <section style={{ marginTop: '110px', marginLeft: isMobile ? '0px' : '100px', marginRight: isMobile ? '0px' : '100px', borderRadius: isMobile ? '0px' : '40px', overflow: 'hidden', position: 'relative', height: isMobile ? '250px' : '600px' }}>
                    <div style={{ position: 'relative', width: '100%', height: '100%' }}>
                        ...
                        <div style={{ position: 'absolute', inset: '0', display: 'flex', flexDirection: 'column', alignItems: isMobile ? 'center' : 'end', padding: isMobile ? '1rem' : '2rem', color: 'black', zIndex: 20, paddingLeft: isMobile ? '1rem' : '48rem', textAlign: isMobile ? 'center' : 'right' }} className="animate-fadeInUp">
                            ...
                            <h1 className={`${isMobile ? 'text-[30px] text-[white]' : 'text-[50px]'} font-bold animate-fadeInLeft`}>Trusted Since 1989</h1>
                            <p className={`${isMobile ? 'text-[16px] text-[white]' : 'text-[20px]'} text-[#6B7280] ${isMobile ? 'pl-0' : 'pl-[4rem]'} animate-fadeInUp animate-delay-200`}>Delivering high-quality pharmaceutical formulations with precision and care.</p>
                            <div className={`mt-[8px] text-[white] ${isMobile ? 'px-[15px] py-[15px]' : 'px-[20px] py-[20px]'} rounded-[40px] ${isMobile ? 'text-[13px]' : 'text-[15px]'} font-semibold bg-[#33b0c5] hover:bg-[#76ac4e] transition-all duration-300 ease-in-out hover:scale-105 items-center flex gap-[8px] font-[500] cursor-pointer animate-fadeInUp animate-delay-400`} onClick={() => window.location.href = ("/contact-us")}>
        ...
        <section className={`${isMobile ? 'mx-[20px]' : 'mx-[100px]'} mt-[50px] animate-fadeInUp`}>
             <div className={`${isMobile ? 'flex-col' : 'flex'} gap-[20px] justify-between`}>
                ...
                <div className={`${isMobile ? 'mt-[20px] flex-col text-left  gap-[10px]' : 'mt-[170px] flex gap-[20px]'} justify-center`}>
      ...
      <div>Certified</div>
             ...
             <div className={`${isMobile ? 'flex-col gap-[20px] mt-[30px] px-[0px]' : 'gap-[20px] mt-[30px] px-[20px]'} rounded-[10px] justify-between flex bg-[#F3F9EF] animate-fadeInUp`}>
                <div>
                    ...
                    <p className={`${isMobile ? 'text-[18px]' : 'text-[24px]'} font-[400] ${isMobile ? 'px-[10px] ' : 'pr-[20px]'} animate-fadeInUp animate-delay-200`}>Capacity for per month production based on single shift working.</p>
                </div>
    ...
    <div className='flex flex-col text-left gap-[10px]'>
      ...
      <div>21 Crore</div>
        ...
        <section className={`${isMobile ? 'mx-[0px]' : 'mx-[100px]'} mt-[100px] animate-fadeInUp`}>
            <div className={`font-[600] ${isMobile ? 'text-[30px] text-center' : 'text-[40px]'} mb-[30px] animate-fadeInLeft`}>Quality Management System</div>
            <div className={`text-[white] ${isMobile ? 'flex-col' : 'flex'} bg-[#305d94] rounded-[20px] ${isMobile ? 'px-[20px] py-[30px]' : 'px-[60px] py-[50px]'} hover:shadow-2xl transition-all duration-500 ease-in-out`}>
              <div>
