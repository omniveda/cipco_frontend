...
export default function AboutUs(){
  ...
  useEffect(() => {
    ...
    return(
        <>
        <section style={{ marginTop: '110px', marginLeft: isMobile ? '0px' : '100px', marginRight: isMobile ? '0px' : '100px', borderRadius: isMobile ? '0px' : '40px', overflow: 'hidden', position: 'relative', height: isMobile ? '250px' : '600px' }}>
                    <div style={{ position: 'relative', width: '100%', height: '100%' }}>
                        ...
                        {/* Content Overlaid */}
                        <div style={{ position: 'absolute', inset: '0', display: 'flex', flexDirection: 'column', alignItems: isMobile ? 'center' : 'end', padding: isMobile ? '1rem' : '2rem', color: 'black', zIndex: 20, paddingLeft: isMobile ? '1rem' : '48rem', textAlign: isMobile ? 'center' : 'right' }} className="animate-fadeInUp">

                            <h1 className={`${isMobile ? 'text-[30px]' : 'text-[50px]'} font-bold animate-fadeInLeft`}>Trusted Since 1989</h1>
                            <p className={`${isMobile ? 'text-[16px]' : 'text-[20px]'} text-[#6B7280] ${isMobile ? 'pl-0' : 'pl-[4rem]'} animate-fadeInUp animate-delay-200`}>Delivering high-quality pharmaceutical formulations with precision and care.</p>
                            <div className={`mt-[8px] text-[white] ${isMobile ? 'px-[15px] py-[15px]' : 'px-[20px] py-[20px]'} rounded-[40px] ${isMobile ? 'text-[13px]' : 'text-[15px]'} font-semibold bg-[#88C05E] hover:bg-[#76ac4e] transition-all duration-300 ease-in-out hover:scale-105 items-center flex gap-[8px] font-[500] cursor-pointer animate-fadeInUp animate-delay-400`} onClick={() => window.location.href = ("/contact-us")}>
        ...
        <section className={`${isMobile ? 'mx-[20px]' : 'mx-[100px]'} mt-[50px] animate-fadeInUp`}>
             <div className={`${isMobile ? 'flex-col' : 'flex'} gap-[20px] justify-between`}>
                <div>
                    <h1 className={`${isMobile ? 'text-[40px]' : 'text-[60px]'} font-[600] animate-fadeInLeft`}>Who We Are</h1>
                    <p className={`${isMobile ? 'text-[18px]' : 'text-[20px]'} font-[400] text-[#6B7280] ${isMobile ? 'pr-0' : 'pr-[20px]'} animate-fadeInUp animate-delay-200`}>Cipco Pharmaceuticals is a partnership firm founded in 1939, building ISO-quality pharmaceutical formulations with WHO-GMP standards</p>
                </div>


                <div className={`${isMobile ? 'mt-[20px] flex-col gap-[10px]' : 'mt-[170px] flex gap-[20px]'} justify-center`}>
  <div className={`flex flex-row gap-[20px] bg-[#F3F9EF] rounded-[10px] ${isMobile?'py-[10px]':'p-[20px]'} justify-center items-center flex-shrink-0 ${isMobile ? 'w-full' : 'w-[280px]'} hover:scale-105 transition-all duration-300 ease-in-out animate-fadeInRight animate-delay-400`}>
  ...
  <div className={`flex flex-row gap-[20px] bg-[#F3F9EF] ${isMobile?'py-[10px]':'p-[20px]'} rounded-[10px] justify-center items-center flex-shrink-0 ${isMobile ? 'w-full' : 'w-[280px]'} hover:scale-105 transition-all duration-300 ease-in-out animate-fadeInRight animate-delay-600`}>
    ...
    <div className='flex flex-col text-left gap-[10px]'>
      ...
      <div>Certified</div>
             ...
             <div className={`${isMobile ? 'flex-col gap-[20px] mt-[30px] px-[0px]' : 'gap-[20px] mt-[30px] px-[20px]'} rounded-[10px] justify-between flex bg-[#F3F9EF] animate-fadeInUp`}>
                <div>
                    <h1 className={`${isMobile ? 'text-[28px] text-center' : 'text-[33px]'} font-[400] animate-fadeInLeft`}>Capacity of Plant</h1>
                    <p className={`${isMobile ? 'text-[20px]' : 'text-[24px]'} font-[400] ${isMobile ? 'pr-0' : 'pr-[20px]'} animate-fadeInUp animate-delay-200`}>Capacity for per month production based on single shift working.</p>
                </div>


                <div className={`${isMobile ? 'flex-col gap-[10px]' : 'flex gap-[20px]'} justify-center`}>
  <div className={`flex flex-row gap-[20px] bg-[#F3F9EF] rounded-[10px] ${isMobile ? 'p-[0px]' : 'p-[20px]'} justify-center items-center flex-shrink-0 ${isMobile ? 'w-full' : 'w-[280px]'} hover:scale-105 transition-all duration-300 ease-in-out animate-scaleIn animate-delay-400`}>
  ...
  <div className={`flex flex-row gap-[20px] ${isMobile ? 'p-[0px]' : 'p-[20px]'} rounded-[10px] justify-center items-center flex-shrink-0 ${isMobile ? 'w-full' : 'w-[280px]'} hover:scale-105 transition-all duration-300 ease-in-out animate-scaleIn animate-delay-600`}>
    <div className='flex flex-col text-left gap-[10px]'>
      ...
      <div>21 Crore</div>
        ...
        <section className={`${isMobile ? 'mx-[0px]' : 'mx-[100px]'} mt-[100px] animate-fadeInUp`}>
            <div className={`font-[600] ${isMobile ? 'text-[30px]' : 'text-[40px]'} mb-[30px] animate-fadeInLeft`}>Quality Management System</div>
            <div className={`text-[white] ${isMobile ? 'flex-col' : 'flex'} bg-[#0057A0] rounded-[20px] ${isMobile ? 'px-[20px] py-[30px]' : 'px-[60px] py-[50px]'} hover:shadow-2xl transition-all duration-500 ease-in-out`}>
              <div>
              <div className={`${isMobile ? 'text-[18px]' : 'text-[20px]'} mb-[15px] animate-fadeInUp`}>The firm has very clear and recorded quality policy which states that:</div>
              <div className={`${isMobile ? 'flex-col' : 'flex'} ${isMobile ? 'mx-0' : 'mx-[40px]'}`}>
                <div><img src={colon} alt="colon" className={`${isMobile ? 'w-[30px] h-[30px]' : 'w-[40px] h-[40px]'} animate-scaleIn`}/></div>
                <div className={`font-[600] ${isMobile ? 'text-[20px]' : 'text-[22px]'} ${isMobile ? 'pr-0' : 'pr-[200px]'} mt-[30px] animate-fadeInRight animate-delay-200`}>“We, at Cipco Pharmaceuticals, aim to provide satisfaction to our customers in domestic/ international market by fully meeting their requirements in terms of Quality, Cost and Delivery. We have created a company committed to quality by bringing about involvement of all employees at all levels for continuous improvement in Quality.”</div>
              </div>
              </div>
              <div><img src={drhand} className={`${isMobile ? 'w-[200px] h-[200px] mt-[20px]' : 'w-[250px] h-[250px]'} animate-fadeInLeft animate-delay-400`} style={{alignSelf: isMobile ? 'center' : 'auto'}} alt="dr image" /></div>
            </div>
        </section>
