...
export default function AboutUs(){
    return(
        ...
        <section style={{ marginTop: '110px', marginLeft: '100px', marginRight: '100px', borderRadius: '40px', overflow: 'hidden', position: 'relative', height: '600px' }}>
                    <div style={{ position: 'relative', width: '100%', height: '100%' }}>
                        ...
                        {/* Content Overlaid */}
                        <div style={{ position: 'absolute', inset: '0', display: 'flex', flexDirection: 'column', alignItems: 'end', padding: '2rem', color: 'black', zIndex: 20, paddingLeft: '48rem', textAlign: 'right' }} className="animate-fadeInUp">

                            <h1 className='text-[50px] font-bold animate-fadeInLeft'>Trusted Since 1989</h1>
                            <p className=' text-[20px] text-[#6B7280] pl-[4rem] animate-fadeInUp animate-delay-200'>Delivering high-quality pharmaceutical formulations with precision and care.</p>
                            <div className="mt-[8px] text-[white] px-[20px] py-[20px] rounded-[40px] text-[15px] font-semibold bg-[#88C05E] hover:bg-[#76ac4e] transition-all duration-300 ease-in-out hover:scale-105 items-center flex gap-[8px] font-[500] cursor-pointer animate-fadeInUp animate-delay-400" onClick={() => window.location.href = ("/contact-us")}>
        ...
        <section className='mx-[100px] mt-[50px] animate-fadeInUp'>
             <div className=' gap-[20px] justify-between flex'>
                <div>
                    <h1 className='text-[60px] font-[600] animate-fadeInLeft'>Who We Are</h1>
                    <p className='text-[20px] font-[400] text-[#6B7280] pr-[20px] animate-fadeInUp animate-delay-200'>Cipco Pharmaceuticals is a partnership firm founded in 1939, building ISO-quality pharmaceutical formulations with WHO-GMP standards</p>
                </div>


                <div className='mt-[170px] flex gap-[20px]  justify-center'>
  <div className='flex flex-row gap-[20px] bg-[#F3F9EF] rounded-[10px] p-[20px] justify-center items-center flex-shrink-0 w-[280px] hover:scale-105 transition-all duration-300 ease-in-out animate-fadeInRight animate-delay-400'>
  ...
  <div className='flex flex-row gap-[20px] bg-[#F3F9EF] p-[20px] rounded-[10px] justify-center items-center flex-shrink-0 w-[280px] hover:scale-105 transition-all duration-300 ease-in-out animate-fadeInRight animate-delay-600'>
    <div className='bg-[#1C64F2] rounded-full inline-block p-[10px] px-[15px]'>
    ...
    <div className='flex flex-col text-left gap-[10px]'>
      ...
      <div>Certified</div>
             ...
             <div className=' gap-[20px] mt-[30px] px-[20px] rounded-[10px] justify-between flex bg-[#F3F9EF] animate-fadeInUp'>
                <div>
                    <h1 className='text-[33px] font-[400] animate-fadeInLeft'>Capacity of Plant</h1>
                    <p className='text-[24px] font-[400] pr-[20px] animate-fadeInUp animate-delay-200'>Capacity for per month production based on single shift working.</p>
                </div>


                <div className=' flex gap-[20px]  justify-center'>
  <div className='flex flex-row gap-[20px] bg-[#F3F9EF] rounded-[10px] p-[20px] justify-center items-center flex-shrink-0 w-[280px] hover:scale-105 transition-all duration-300 ease-in-out animate-scaleIn animate-delay-400'>
  ...
  <div className='flex flex-row gap-[20px] p-[20px] rounded-[10px] justify-center items-center flex-shrink-0 w-[280px] hover:scale-105 transition-all duration-300 ease-in-out animate-scaleIn animate-delay-600'>
    <div className='flex flex-col text-left gap-[10px]'>
      ...
      <div>21 Crore</div>
        ...
        <section className='mx-[100px] mt-[100px] animate-fadeInUp'>
            <div className='font-[600] text-[40px] mb-[30px] animate-fadeInLeft'>Quality Management System</div>
            <div className='text-[white] flex bg-[#0057A0] rounded-[20px] px-[60px] py-[50px] hover:shadow-2xl transition-all duration-500 ease-in-out'>
              <div>
              <div className='text-[20px] mb-[15px] animate-fadeInUp'>The firm has very clear and recorded quality policy which states that:</div>
              <div className='flex mx-[40px]'>
                <div><img src={colon} alt="colon" className='w-[40px] h-[40px] animate-scaleIn'/></div>
                <div className='font-[600] text-[22px] pr-[200px] mt-[30px] animate-fadeInRight animate-delay-200'>“We, at Cipco Pharmaceuticals, aim to provide satisfaction to our customers in domestic/ international market by fully meeting their requirements in terms of Quality, Cost and Delivery. We have created a company committed to quality by bringing about involvement of all employees at all levels for continuous improvement in Quality.”</div>
              </div>
              </div>
              <div><img src={drhand} className='w-[250px] h-[250px] animate-fadeInLeft animate-delay-400' alt="dr image" /></div>
            </div>
        </section>
