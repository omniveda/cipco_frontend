...
export default function AboutUs(){
  ...
  <div className={`flex flex-row gap-[20px] bg-[#cce4e8] rounded-[10px] ${isMobile?'py-[10px] mb-[10px]':'p-[20px]'} ${isMobile?'pl-[10px]':'justify-center items-center'} flex-shrink-0 ${isMobile ? 'w-full' : 'w-[280px]'} hover:scale-105 transition-all duration-300 ease-in-out animate-fadeInRight animate-delay-400`}>
  ...
  <div className={`flex flex-row gap-[20px] bg-[#cce4e8] ${isMobile?'py-[10px]':'p-[20px]'} rounded-[10px] ${isMobile?'pl-[10px]':'justify-center items-center'} flex-shrink-0 ${isMobile ? 'w-full' : 'w-[280px]'} hover:scale-105 transition-all duration-300 ease-in-out animate-fadeInRight animate-delay-600`}>
    ...
    <div className='flex flex-col text-left gap-[10px]'>
      ...
      <div>Certified</div>
             ...
             <div ref={capacityRef} className={`${isMobile ? 'flex-col gap-[20px] mt-[30px] px-[0px]' : 'gap-[20px] mt-[30px] px-[20px]'} rounded-[10px] justify-between flex bg-[#cce4e8]`} style={{
  ...
  <div className={`flex flex-row gap-[20px] bg-[#cce4e8] rounded-[10px] ${isMobile ? 'p-[0px]' : 'p-[20px]'} ${isMobile?'pl-[10px]':'justify-center items-center'} flex-shrink-0 ${isMobile ? 'w-xfull' : 'w-[280px]'} hover:scale-105 transition-all duration-300 ease-in-out animate-scaleIn animate-delay-400`}>
  ...
  <div className={`flex flex-row gap-[20px] ${isMobile ? 'p-[0px]' : 'p-[20px]'} rounded-[10px] ${isMobile?'pl-[10px]':'justify-center items-center'} flex-shrink-0 ${isMobile ? 'w-full' : 'w-[280px]'} hover:scale-105 transition-all duration-300 ease-in-out animate-scaleIn animate-delay-600`}>
    <div className='flex flex-col text-left gap-[10px]'>
      <div className='font-[600] text-[30px] text-[#33b0c5]'>Oral Tablet</div>
      <div>21 Crore</div>
    </div>
  </div>
</div>
