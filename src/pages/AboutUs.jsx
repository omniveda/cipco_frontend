...
export default function AboutUs(){
  ...
  useEffect(() => {
    ...
    return(
        ...
        <section ref={whoWeAreRef} className={`${isMobile ? 'mx-[20px]' : 'mx-[100px]'} mt-[10px]`} style={{
  ...
  <div className={`flex flex-row gap-[20px] bg-[#F3F4F6] rounded-[10px] ${isMobile?'py-[10px] mb-[10px]':'p-[20px]'} ${isMobile?'pl-[10px]':'justify-center items-center'} flex-shrink-0 ${isMobile ? 'w-full' : 'w-[280px]'} hover:scale-105 transition-all duration-300 ease-in-out animate-fadeInRight animate-delay-400`}>
    <div className='bg-[#305d94] rounded-full inline-block p-[10px]'>
  ...
  <div className={`flex flex-row gap-[20px] bg-[#F3F4F6] ${isMobile?'py-[10px]':'p-[20px]'} rounded-[10px] ${isMobile?'pl-[10px]':'justify-center items-center'} flex-shrink-0 ${isMobile ? 'w-full' : 'w-[280px]'} hover:scale-105 transition-all duration-300 ease-in-out animate-fadeInRight animate-delay-600`}>
    <div className={isMobile?'bg-[#305d94] rounded-full inline-block p-[10px] px-[15px]':'bg-[#305d94] rounded-full inline-block p-[10px] px-[15px]'}>
    ...
    <div className='flex flex-col text-left gap-[10px]'>
      ...
      <div>Certified</div>
             ...
             <div ref={capacityRef} className={`${isMobile ? 'flex-col gap-[20px] mt-[30px] px-[0px]' : 'gap-[20px] mt-[30px] px-[20px]'} rounded-[10px] justify-between flex bg-[#F3F4F6]`} style={{
  ...
  <div className={`flex flex-row gap-[20px] bg-[#F3F4F6] rounded-[10px] ${isMobile ? 'p-[0px]' : 'p-[20px]'} ${isMobile?'pl-[10px]':'justify-center items-center'} flex-shrink-0 ${isMobile ? 'w-xfull' : 'w-[280px]'} hover:scale-105 transition-all duration-300 ease-in-out animate-scaleIn animate-delay-400`}>

    <div className='flex flex-col text-left gap-[10px]'>
      <div className='font-[600] text-[30px] text-[#305d94]'>Oral Liquid</div>
  ...
  <div className={`flex flex-row gap-[20px] ${isMobile ? 'p-[0px]' : 'p-[20px]'} rounded-[10px] ${isMobile?'pl-[10px]':'justify-center items-center'} flex-shrink-0 ${isMobile ? 'w-full' : 'w-[280px]'} hover:scale-105 transition-all duration-300 ease-in-out animate-scaleIn animate-delay-600`}>
    <div className='flex flex-col text-left gap-[10px]'>
      <div className='font-[600] text-[30px] text-[#305d94]'>Oral Tablet</div>
      <div>21 Crore</div>
    </div>
  </div>
</div>
        ...
        <section ref={qualityRef} className={`${isMobile ? 'mx-[0px]' : 'mx-[100px]'} mt-[70px]`} style={{
       ...
       {!isMobile && <section className={`${isMobile ? 'mx-[0px]' : 'mx-[100px]'} mt-[70px]`}>
          <Chart />
        </section>}

        <section className={`${isMobile ? 'mx-[10px]' : 'mx-[100px]'} mt-[70px]`}>
          <Slider/>
        </section>

        <section className={`${isMobile ? 'mx-[0px]' : 'mx-[100px]'} mt-[70px]`}>
          <AboutContent/>
        </section>

        <section className={`${isMobile ? 'mx-[20px]' : 'mx-[100px]'} mt-[70px]`}>
          <Production/>
        </section>
        </>
    );
