...
export default function Teams() {
    ...
    const teams = [
        ...
        },
        {
            ...
            designation: 'Chief Financial Officer & Director, Cipco Limited.',
                        ...
                        <div style={{
                            ...
                            <div style={{
                                ...
                                <div style={{
                                    ...
                                    <p className="text-xl text-blue-600 mb-4 font-medium">{selectedTeam.designation}</p>
                                    <blockquote className="text-lg italic text-gray-700 mb-6 border-l-4 border-blue-500 pl-4">
                                        {selectedTeam.quote}
                                    </blockquote>
                                    <p className="text-gray-700 leading-relaxed text-justify">{selectedTeam.Details}</p>
                                </div>
                            </div>
                        </div>
                    </div>
